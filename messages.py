...
DAY0_CONFIRM = {
    ...
    "en": "I'll send useful content once a day for a few days. No spam 🙂\n\nIf you'd like to talk now — just write. I'll reply personally."
}
...
Хочешь разобраться со своей ситуацией? В следующем сообщении покажу, как проходит бесплатный первый урок.""",
...
В следующем сообщении покажу, как проходит бесплатный первый урок.""",
...
Want to sort out your situation? In the next message, I’ll show how the free first lesson works.""",
...
In the next message, I’ll show how the free first lesson works.""",
